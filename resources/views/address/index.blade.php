...
<script>
    ...
    function makeListJson(jsonStr) {
        ...
        htmlStr +=
            '<table class="responsive table table-bordered"><th>도로명 주소</th>' 
            // +'<th>zipNo</th><th>admCd (code)</th>'
    ...
    <div>
        <div class="items-center justify-center grid pt-10">
            <div class="items-center">
                ㅁㄴㅇㄹ
                <form class="md:w-1/2"id="form" name="form" method="post">
                    <input class="" type="text" name="keyword" value="광화문 풍림" placeholder="지역명 + 아파트명" onkeydown="enterSearch();" />
