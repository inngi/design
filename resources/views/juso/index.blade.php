...
<x-app-layout>
    ...
    <div>
        <script>
            ...
            function makeListJson(jsonStr) {
                ...
                htmlStr += '<table class="responsive table table-bordered"><th>도로명 주소</th><th>zipNo</th><th>admCd (code)</th>'
    ...
    '<input type="text" name="value2" value="2"><input type="text" name="value3" value="3">'+    '<input type="text" name="value4" value="4"><button type="submit" name="sumit">제춧</button>'+
    '</form>'
            ...
            function jusoCallBack(stringA, lnbrMnnm, doro, lnbrSlno) {
                ...
                $("#sold_price").load("juso.sold_price4" + "?admCd=" + stringA + "&lnbrMnnm=" + lnbrMnnm + "&doro=" +
                    doro + "&lnbrSlno=" + lnbrSlno);
